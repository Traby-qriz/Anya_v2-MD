...
module.exports = {
     ...
     */
    botname: process.env.BotName || "CASPE-XMD",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 CASPER TECH",
     ...
     */
    ownername: process.env.OWNER_NUMBER || process.env.Owner_Name || "TRABY QRIZ",
    ownernumber: process.env.Owner_Number || "254732982940",
    instagramId: process.env.Insta || "samchriskym.official",

    /**
     * other details and parameters
     */
    author: process.env.Author || "CASPER TECH 🌚🌙",
    packname: process.env.PackName || "𝕼𝖚𝖊𝖊𝖓 𝕬𝖓𝖞𝖆 𝖁2 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    socialLink: process.env.Web || "https://github.com/Traby-qriz",
    ...
    sessionId: process.env.SESSION_ID || "pt9thm7XVFthQ_A_N_Y_A_V_2_RPH2pSV",
