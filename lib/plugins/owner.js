...
const ownerSwitches = [
    {
        name: "alwaysonline",
        name2: "Always Online",
        alias: ['alwayson', 'online'],
        emoji: "⚡",
        desc: "Enable or disable always online showing",
        id: "alwaysOnline",
        turnOff: []
    },
    {
...
anya({
    ...
    if (/^on|off$/.test(args[0].toLowerCase())) return pika.reply(`Use \`${prefix}act ${command}\` to turn on or off this function`);
