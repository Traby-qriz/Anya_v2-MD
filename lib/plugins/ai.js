...
anya(
        {
            ...
            need: "text",
            category: "ai",
            desc: "Create anime images using artificial intelligence using Anime Screenscap v1 SDXL model",
            cooldown: 8,
            filename: __filename
        },
    async (anyaV2, pika, { args }) => {
        ...
        HFClient(text, { model: 'John6666/ras-real-anime-screencap-v1-sdxl' })
        .then(async (response) => {
